...
public class MBCharts implements Serializable {
	...
	public void getTotalMensagensRecebidasScriptAnalisadas() {
		Collection<MensagemRecebidaTipoEntrada> itens = service.getTotalMensagensRecebidasTipoEntradaEntreDatas(dataDe, dataAte);
		inicializar(itens);
	...
	public void getTotalMensagensAbertasAtendente() {
		Map<String, Long> itens = service.getTotalMensagensAbertasPorAtendente(dataDe, dataAte, encerradasScriptBool);
		inicializar();
		ChartHelper.getTotalMensagensAbertasAtendente(itens, labels, dados);
	}
